...
<div class="card card-purple card-outline">
	<div class="card-header">
		<h5 class="card-title">Pedidos Realizado Hoy</h5>
	</div>
	<div class="card-body">
...
orders.orderDate as orderdate, s.id as idS , s.total_price, s.sale_portal as tipeSale,orders.orderStatus as orderStatus,
orders.id as idOrder , sd.id as idDetailSale
					...
					?>
							<tr>
								...
								<td>
									...
									<?php } ?>
									<br>
									<a href="detalle_de_venta.php?id=<?php echo $row['idS']; ?>" class="btn btn-info"><i class='fas fa-info'></i></a>
								</td>
							</tr>
