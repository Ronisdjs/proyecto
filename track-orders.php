	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'>Seguir tus pedidos</li>
			</ul>
...
<div class="body-content outer-top-bd">
	...
	<span class="title-tag inner-top-vs">Ingrese su Numero de pedido en el cuadro a continuación y presione Enter. Esto se le proporcionó en su recibo y en el correo electrónico de confirmación que debería haber recibido. </span>
	<form class="register-form outer-top-xs" role="form" method="post" action="order-details.php">
		<div class="form-group">
		    <label class="info-title" for="exampleOrderId1">Numero de orden</label>
