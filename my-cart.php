					...
					<div class="col-md-4 col-sm-12 estimate-ship-tax">
						<table class="table table-bordered">
							<thead>
								<tr>
									<th>
										<span class="estimate-title">Direccion de facturación</span>
									</th>
								</tr>
							</thead>
							<tbody>
									...
									<td>
										<div class="form-group">
											...
											?>
												...
												<div class="form-group">
													<label class="info-title" for="Billing State ">Barrio de facturación <span>*</span></label>
									...
									<td>
										<div class="form-group">
											...
											?>
												...
												<div class="form-group">
													<label class="info-title" for="Billing State ">Barrio de envío <span>*</span></label>
												...
												<button type="submit" name="shipupdate" class="btn-upper btn btn-primary checkout-page-button">Actualziar</button>
											<?php } ?>
								...
								<tr>
									<td>
										<div class="cart-checkout-btn pull-right">
											<button type="submit" name="ordersubmit" class="btn btn-primary">Realizar Compra</button>
