		...
		<div class='container-fluid'>
			<div class='row outer-bottom-sm'>
							...
							<nav class="yamm megamenu-horizontal" role="navigation">
								...
								<ul class="nav">
									<li class="dropdown menu-item">
										<?php $sql = mysqli_query($con, "select id,subcategory  from subcategory where categoryid='$cid' and status = '1'");
				...
				<div class='col-md-9'>
						...
						<div class="item">
							...
							<div class="container-fluid">
								<div class="caption vertical-top text-left">
									...
									<?php $sql = mysqli_query($con, "select categoryName  from category where id='$cid' and status '1'");
									while ($row = mysqli_fetch_array($sql)) {
									?>

										<div class="excerpt hidden-sm hidden-md" style="color: black;">
					...
					<div class="search-result-container" style="margin-top: 250px;">
						<div id="myTabContent" class="tab-content">
							<div class="tab-pane active " id="grid-container">
								<div class="category-product  inner-top-vs">
									<div class="row">
										<?php
										$ret = mysqli_query($con, "select * from products where category='$cid'  and status = '1'");
													...
													<div class="products">
														<div class="product">
															<div class="product-image">
																<div class="image">
																	<a href="product-details.php?pid=<?php echo htmlentities($row['id']); ?>"><img src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['id']); ?>/<?php echo htmlentities($row['productImage1']); ?>" alt="" width="200" height="150"></a>
																</div><!-- /.image -->
															</div><!-- /.product-image -->
