				...
				<div class="caption vertical-top text-left">
					<div class="big-text">
						<br />
					       ...
					       <?php $sql=mysqli_query($con,"select subcategory  from subcategory where id='$cid' and status = 1");
while($row=mysqli_fetch_array($sql))
{
    ?>
					...
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane active " id="grid-container">
							<div class="category-product  inner-top-vs">
								<div class="row">									
			<?php
$ret=mysqli_query($con,"select * from products where subCategory='$cid' and status = 1");
