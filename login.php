...
<body class="cnt-home" style="background-color: #F7F7F7;">
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 sign-in" >
						...
						<form class="register-form outer-top-xs" method="post">
							...
							<div class="radio outer-xs">
								<a href="forgot-password.php" class="forgot-password pull-right">Olvido su contraseña?</a>
							</div>
					...
					<div class="col-md-6 col-sm-6 create-new-account">
						...
						<form class="register-form outer-top-xs" role="form" method="post" name="register" onSubmit="return valid();">
							...
							<div class="form-group">
								<label class="info-title" for="contactno">No. Contacto. <span>*</span></label>
						...
						<div class="checkbox">
							<label class="checkbox">
								Agilizar tu proceso de pago.
							</label>
							<label class="checkbox">
								Realizar un seguimiento de tus pedidos fácilmente.
							</label>
							<label class="checkbox">
