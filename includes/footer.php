                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    ...
                    <div class="contact-info">
                        ...
                        <div class="module-body m-t-20">
                            <p class="about-us"> JambEcommerce es una tienda en línea que ofrece una amplia variedad de productos de calidad a precios competitivos. Descubre una experiencia de compra rápida y segura, con opciones de pago flexibles y envíos a todo el país.</p>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    <tbody>
                                        <tr>
                                            <td>Lunes-Viernes:</td>
                                            <td class="pull-right">08:00 a 18:00</td>
                                        </tr>
                                        <tr>
                                            <td>Sabado:</td>
